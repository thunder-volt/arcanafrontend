...
const DemoLine = () => {
    ...
    const asyncFetch = () => {
        fetch('http://localhost:8000/csvdata18')
...
//     const asyncFetch = () => {
//         fetch('http://localhost:8000/csvdata4')
//             .then((response) => response.json())
//             .then((json) => setData(json))
//             .catch((error) => {
//                 console.log('fetch data failed', error);
...
const DemoLine1 = () => {
    ...
    const asyncFetch = () => {
        fetch('http://localhost:8000/csvdata32 ')
            .then((response) => response.json())
            .then((json) => setData(json))
            .catch((error) => {
                console.log('fetch data failed', error);
...
const DemoDualAxes = () => {
    ...
    const csvData = async () => {
        const result = await fetch('http://localhost:8000/csvdata4').then(async (res) => {
            console.log(res);
